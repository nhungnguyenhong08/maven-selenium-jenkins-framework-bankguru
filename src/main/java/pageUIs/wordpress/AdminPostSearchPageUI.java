...
public class AdminPostSearchPageUI {
	...
	public static final String ROW_CHECKBOX_BY_TITLE_NAME = "xpath=//table[contains(@class,'table-view-list posts')]/tbody//tr/th//span[contains(text(),'%s')]/parent::label/preceding-sibling::input";
