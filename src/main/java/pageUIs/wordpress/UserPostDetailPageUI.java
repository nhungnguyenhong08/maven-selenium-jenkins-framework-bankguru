...
public class UserPostDetailPageUI {
	...
	public static final String POST_CURRENT_DATE_BY_POST_TITLE_EDITED = "xpath=//article//h1[text()='%s']/following-sibling::div//time[@class='entry-date published' and text()='%s']";
}